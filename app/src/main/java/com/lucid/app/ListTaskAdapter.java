...
public class ListTaskAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            ...
            holder.task_date.setText("Date: "+song.get(TaskHome.KEY_DATE));
            holder.task_time.setText("Time: "+song.get(TaskHome.KEY_TIME));
...
class ListTaskViewHolder {
    TextView task_image;
    TextView task_name, task_date, task_time, task_location;
}