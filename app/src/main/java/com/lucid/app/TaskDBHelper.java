...
public class TaskDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "CREATE TABLE "+CONTACTS_TABLE_NAME +
                        "(id INTEGER PRIMARY KEY, task TEXT, dateStr INTEGER, timeStr TEXT, locationStr TEXT)"
        );
    }
    ...
    public boolean insertContact  (String task, String dateStr, String timeStr, String locationStr)
    {
        Date date;
        ...
        contentValues.put("timeStr", timeStr);
        contentValues.put("locationStr", locationStr);
        db.insert(CONTACTS_TABLE_NAME, null, contentValues);
        return true;
    }

    public boolean updateContact (String id, String task, String dateStr, String timeStr, String locationStr)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
